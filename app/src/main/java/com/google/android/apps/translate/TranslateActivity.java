...
public class TranslateActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("GOTranslate", "TranslateActivity started");
    ...
    private void redirectToOffline(Intent incomingIntent) {
        Log.d("GOTranslate", "Redirecting to offline translator");
        ...
        if (Intent.ACTION_SEND.equals(action)) {
            if ("text/plain".equals(incomingIntent.getType())) {
                ...
                if (!TextUtils.isEmpty(sharedText)) {
                    ...
                    Log.d("GOTranslate", "Sending text: " + sharedText);
                }
                ...
                if (imageUri != null) {
                    ...
                    Log.d("GOTranslate", "Sending image: " + imageUri);
                }
            }
            ...
            if (!TextUtils.isEmpty(textToTranslate)) {
                ...
                Log.d("GOTranslate", "Translating text: " + textToTranslate);
            }
        }
